...
class ContaContabilOperadoraJdbcRepositoryTest {
    ...
    private ContaContabilOperadoraJdbcRepository repository;

    @BeforeEach
    void setUp() {
        repository = new ContaContabilOperadoraJdbcRepository(jdbcTemplate);
    }

    @Test
    void deveRetornarDestinoContaContabilOperadora() {
        assertEquals(DestinoImportacaoEnum.CONTA_CONTABIL_OPERADORA, repository.getDestino());
    }
    ...
    void deveChamarBatchInsertComSqlCorretoESetterConfigurado() throws SQLException {
        ...
        assertAll(
                ...
                () -> assertEquals(SqlStatements.INSERT_CONTA_CONTABIL_OPERADORA, sqlCaptor.getValue()),
    ...
    void deveChamarBatchUpdateComSqlCorretoESetterConfigurado() throws SQLException {
        ...
        assertAll(
                ...
                () -> assertEquals(SqlStatements.UPDATE_CONTA_CONTABIL_OPERADORA, sqlCaptor.getValue()),
    ...
    void deveExecutarInsertIndividualCorretamente() {
        ...
        when(jdbcTemplate.update(
                eq(SqlStatements.INSERT_CONTA_CONTABIL_OPERADORA),
    ...
    void deveExecutarUpdateIndividualCorretamente() {
        ...
        when(jdbcTemplate.update(
                eq(SqlStatements.UPDATE_CONTA_CONTABIL_OPERADORA),
                any(), any(), any(), any(), any(), any()
        )).thenReturn(1);
